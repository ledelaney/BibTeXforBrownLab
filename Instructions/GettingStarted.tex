...
I know on the outset this may seem harder than simply using Word --- it will likely be frustrating to get started, but will feel easier the more you practice (like everything). I wish I started using \LaTeX\ and Zotero a lot sooner, as it would have saved me a lot of struggle and heartache (god forbid you are starting your reference manager and Bib\TeX\ journey mid-manuscript). As you get better, you'll be able to look up all kinds of tricks and customizations to make your documents look super dope. Hopefully this helps get you started.
